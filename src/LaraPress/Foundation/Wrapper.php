...
use LaraPress\Field\Fields\FieldBuilder;
...
abstract class Wrapper {
     ...
     * @return array
     */
    private function parseArrayable(FieldBuilder $field, $value = [])
    {
     ...
     * @return array
     */
    private function parseInfinite(FieldBuilder $field, $value = [])
    {
        $fields = $field['fields'];
